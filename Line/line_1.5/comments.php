...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number(__('暂无评论', 'kubrick'), __('一条评论', 'kubrick'), __('% 条评论', 'kubrick'));?></h3>
...
<h3><?php comment_form_title( __('发表评论', 'kubrick'), __('Leave a Reply for %s' , 'kubrick') ); ?></h3>
...
<label for="author"><small><?php _e('姓名', 'kubrick'); ?> <?php if ($req) _e("(必填)", "kubrick"); ?></small></label></p>

<p><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
<label for="email"><small><?php _e('邮箱 (不会公开)', 'kubrick'); ?> <?php if ($req) _e("(必填)", "kubrick"); ?></small></label></p>
